...
const joao = criarPessoa('João', 30, 'masculino');
const lucia = criarPessoa('Lúcia', 35, 'feminino');
...
const roger = new Pessoa('Roger', 12, 'masculino');
const julia = new Pessoa('Julia', 10, 'feminino');
...
if(f.prototype !== null) {
 ...
 const ret = f.aplly(res, Array.prototype.slice.call(arguments, 1));
